...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900 font-sans selection:bg-[#0052ff] selection:text-white">
      {/* Navigation Header */}
      <Navbar
      ...
      <a
        ...
        className="fixed bottom-6 right-6 z-40 px-5 py-3.5 bg-[#0052ff] text-white rounded-full shadow-xl shadow-blue-500/25 hover:bg-blue-700 transition-all duration-300 flex items-center justify-center group cursor-pointer hover:scale-105"
        title="Conversar no WhatsApp"
      >
        <MessageSquare className="w-4 h-4 fill-white" />
        <span className="font-mono text-xs font-bold uppercase tracking-wider pl-2">
          Falar no WhatsApp
        </span>
      </a>
    </div>
